                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <?php
                                    $whatsapp_message = urlencode("Hello, I'm interested in your property listing: {$row['name']} at {$row['locations_name']}.");
                                    $whatsapp_link = "https://wa.me/{$row['phone']}?text={$whatsapp_message}";
                                    ?>
                                    
                                    <a href="<?php echo $whatsapp_link; ?>" target="_blank" class="btn btn-success btn-sm"><i class="fab fa-whatsapp"></i> WhatsApp</a>
